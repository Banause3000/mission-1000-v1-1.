...
USER_AGENT = "Mission1000-DataEngine/5.0-WTA-HISTORY"
...
def main():
    print("=" * 68)
    print("MISSION 1000 DATA ENGINE v5.0 WTA HISTORY H2H")
    print("RUNNING FILE: collector/fetch_intelligence_v5_wta_history.py")
    print("=" * 68)
    ...
    td_wta_rows, td_sources = load_tennisdata_wta_history()
    rows.extend(td_wta_rows)
    sources.extend(td_sources)
    ...
    save_json(SOURCE / "rankings_fallback.json", {
        "generatedAt": now,
        "source": "Mission 1000 Data Engine v5.0 - latest observed match rankings",
        "players": ranking_fallback,
    })

    save_json(SOURCE / "players.json", {
        "generatedAt": now,
        "source": "Mission 1000 Data Engine v5.0",
        "players": players,
    })
    ...
    print("DATA ENGINE v5.0 WTA HISTORY H2H: OK")
