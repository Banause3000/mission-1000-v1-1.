...
USER_AGENT = "Mission1000-DataEngine/4.0-H2H-DISCOVERY"
...
def debug_pegula_shnaider_h2h(directory):
    ...
    print("=" * 64)
    print("WTA H2H V4 DEBUG: PEGULA vs SHNAIDER")
    print("=" * 64)
...
def main():
    print("=" * 68)
    print("MISSION 1000 DATA ENGINE v4.0 H2H ENDPOINT DISCOVERY")
    print("RUNNING FILE: collector/fetch_intelligence_v4_h2h_fix.py")
    print("=" * 68)
    ...
    print("DATA ENGINE v4.0 H2H DISCOVERY: OK")
